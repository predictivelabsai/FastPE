...
TRANSLATIONS: dict[str, dict[str, str]] = {
    ...
    "news_pe_heading":   {"en": "Private equity industry news",
                          "et": "Erakapitali tööstuse uudised",
                          "lt": "Privataus kapitalo pramonės naujienos",
                          "fi": "Pääomasijoitusalan uutiset",
                          "sv": "Private equity-branschens nyheter"},
    "news_pe_sources":   {"en": "PE Hub · Buyouts Insider · PE International",
                          ...
                          "sv": "PE Hub · Buyouts Insider · PE International"},
