...
TRANSLATIONS: dict[str, dict[str, str]] = {
    ...
    "hero_eyebrow":      {"en": "Agentic AI for private equity",
                          ...
                          "no": "Agentisk AI for private equity",
                          "da": "Agentisk AI til private equity",
    ...
    "hero_h1_1":         {"en": "Your Private Equity ",       "et": "Teie erakapitali ",          "lt": "Jūsų privataus kapitalo ",
                          ...
                          "da": "Din Private Equity",
                          "fr": "Votre Private Equity",
                          "de": "Ihr Private Equity",
                          "pl": "Twój Private Equity"},
    ...
    "hero_lede":         {"en": "Not a prompt pack. Not a build-it-yourself kit. PEHero is a full agentic system "
                          ...
                          "lv": "Nav uzvedņu komplekts. Nav paštaisīšanas komplekts. PEHero ir pilna aģentiskā sistēma, kas jau integrēta jūsu darījumu plūsmā — skenējot mērķus, veicot QoE, veidojot LBO modeļus un sagatavojot IC memorandus, kamēr jūsu komanda koncentrējas uz zvanu.",
                          "no": "Ikke en prompt-pakke. Ikke et gjør-det-selv-kit. PEHero er et fullstendig agentisk system allerede koblet til deal flow — skanner targets, kjører QoE, bygger LBO-modeller og utarbeider IC-memoer mens teamet ditt fokuserer på samtalen.",
                          "da": "Ikke en prompt-pakke. Ikke et gør-det-selv-kit. PEHero er et fuldt agentisk system allerede integreret i din deal flow — scanner targets, kører QoE, bygger LBO-modeller og udarbejder IC-memoer mens dit team fokuserer på opkaldet.",
                          "fr": "Pas un pack de prompts. Pas un kit à construire soi-même. PEHero est un système agentique complet déjà intégré à votre flux de deals — scannant les cibles, exécutant les QoE, construisant des modèles LBO et rédigeant des mémos IC pendant que votre équipe se concentre sur l'appel.",
                          "de": "Kein Prompt-Paket. Kein Baukasten zum Selbermachen. PEHero ist ein vollständiges agentisches System, das bereits in Ihren Deal-Flow integriert ist — Ziele scannen, QoE durchführen, LBO-Modelle erstellen und IC-Memos verfassen, während sich Ihr Team auf das Gespräch konzentriert.",
                          "pl": "Nie jest to zestaw promptów. Nie jest to zestaw do samodzielnego budowania. PEHero to pełny system agentyczny już zintegrowany z Twoim przepływem transakcji — skanujący cele, przeprowadzający QoE, budujący modele LBO i przygotowujący notatki IC, podczas gdy Twój zespół skupia się na rozmowie."},
    ...
    "stat_squad_cap":    {"en": "of PE specialists, on call",
                          ...
                          "lv": "PE speciālistu komanda, kas pieejama",
                          "no": "av PE-spesialister, på vakt",
                          "da": "af PE-specialister, på vagt",
                          "fr": "de spécialistes PE, sur appel",
                          "de": "aus PE-Spezialisten, auf Abruf",
                          "pl": "specjalistów PE, do dyspozycji"},
    ...
    "pillars_heading":   {"en": "Every role your deal team plays — live inside PEHero.",
                          ...
                          "lv": "Katra loma, ko spēlē jūsu darījumu komanda — dzīvo PEHero.",
                          "no": "Hver rolle deal-teamet ditt spiller — live inne i PEHero.",
                          "da": "Hver rolle dit deal-team spiller — live inde i PEHero.",
                          "fr": "Chaque rôle de votre équipe de deal — en direct dans PEHero.",
                          "de": "Jede Rolle, die Ihr Deal-Team spielt — live in PEHero.",
                          "pl": "Każda rola, jaką odgrywa Twój zespół transakcyjny — na żywo w PEHero."},
    ...
    "how_heading":       {"en": "Source → Underwrite → Close → Hold.",
                          ...
                          "fr": "Source → Underwrite → Close → Hold.",
                          "de": "Source → Underwrite → Close → Hold.",
                          "pl": "Source → Underwrite → Close → Hold."},
    ...
    "how_02_body":       {"en": "Cap Table Parser, LTM Normalizer, and LBO Model Builder take seller financials "
                          ...
                          "lv": "Kapitāla tabulas parsētājs, LTM normalizētājs un LBO modeļa veidotājs pārveido pārdevēja finanšu datus par IC gatavu 5 gadu modeli ar jutīgumu un parādu struktūru — jau salīdzinātu ar reāliem darījumu salīdzinājumiem.",
                          "no": "Cap Table Parser, LTM Normalizer og LBO Model Builder tar selgers finansielle data til en IC-klar 5-årsmodell med sensitivitet og gjeldsstabel — allerede benchmarket mot live transaksjonscomps.",
                          "da": "Cap Table Parser, LTM Normalizer og LBO Model Builder omdanner sælgers finansielle data til en IC-klar 5-års model med sensitivitet og debt stack — allerede benchmarket mod live transaction comps.",
                          "fr": "Cap Table Parser, LTM Normalizer et LBO Model Builder transforment les données financières du vendeur en un modèle sur 5 ans prêt pour le CI, avec analyse de sensibilité et pile de dette — déjà comparé aux transactions comparables en direct.",
                          "de": "Cap Table Parser, LTM Normalizer und LBO Model Builder wandeln Verkäufer-Finanzen in ein IC-bereites 5-Jahres-Modell mit Sensitivitätsanalyse und Debt Stack um — bereits anhand aktueller Transaktions-Comps benchmarked.",
                          "pl": "Cap Table Parser, LTM Normalizer i LBO Model Builder przekształcają dane finansowe sprzedawcy w gotowy do IC model 5-letni z analizą wrażliwości i strukturą długu — już porównany z aktualnymi comps transakcyjnymi."},
    ...
    "case_2_caption":    {"en": "from seller financials + cap table to a full 5-year LBO model with sensitivity and debt stack.",
                          ...
                          "lv": "no pārdevēja finanšu datiem + kapitāla tabulas līdz pilnam 5 gadu LBO modelim ar jutīgumu un parādu struktūru.",
                          "no": "fra selgers finansielle data + cap table til en full 5-års LBO-modell med sensitivitet og gjeldsstabel.",
                          "da": "fra sælgers finansielle data + cap table til en fuld 5-års LBO-model med sensitivitet og debt stack.",
                          "fr": "des données financières du vendeur + table de capitalisation à un modèle LBO complet sur 5 ans avec sensibilité et pile de dette.",
                          "de": "von Verkäufer-Finanzen + Cap Table zu einem vollständigen 5-Jahres-LBO-Modell mit Sensitivität und Debt Stack.",
                          "pl": "od danych finansowych sprzedawcy + cap table do pełnego 5-letniego modelu LBO z analizą wrażliwości i strukturą długu."},
    ...
    "cta_body":          {"en": "Book a 20-minute walkthrough. We'll load one of your recent deals into PEHero "
                          ...
                          "lv": "Rezervējiet 20 minūšu pārskatu. Mēs ielādēsim vienu no jūsu nesenajiem darījumiem PEHero un parādīsim pilnu aģentu plūsmu no sākuma līdz beigām.",
                          "no": "Book en 20-minutters gjennomgang. Vi laster inn en av dine nylige deals i PEHero og viser deg hele agentflyten fra ende til ende.",
                          "da": "Book en 20-minutters gennemgang. Vi loader en af dine nylige deals ind i PEHero og viser dig den fulde agent flow end-to-end.",
                          "fr": "Réservez une démo de 20 minutes. Nous chargerons l'une de vos transactions récentes dans PEHero et vous montrerons le flux complet des agents de bout en bout.",
                          "de": "Buchen Sie einen 20-minütigen Durchgang. Wir laden einen Ihrer aktuellen Deals in PEHero und zeigen Ihnen den vollständigen Agent-Flow von Anfang bis Ende.",
                          "pl": "Umów 20-minutowy przegląd. Załadujemy jedną z Twoich niedawnych transakcji do PEHero i pokażemy pełny przepływ agentów od początku do końca."},
    ...
    "platform_body":     {"en": "PEHero lives where your deal team already works. Twenty-two specialist "
                          ...
                          "lv": "PEHero dzīvo tur, kur jūsu darījumu komanda jau strādā. Divdesmit divi speciālistu aģenti dalās vienā jūsu cauruļvada, portfeļa un tirgus modelī. Katram aģentam ir savi rīki un uzvednes — un tie nodod artefaktus viens otram bez asociētā atkārtotas ievades.",
                          "no": "PEHero lever der deal-teamet ditt allerede jobber. Tjue-to spesialistagenter deler en enkelt modell av pipeline, portefølje og marked. Hver agent har egne verktøy og prompts — og de sender artifacts mellom hverandre uten at associate må taste inn noe på nytt.",
                          "da": "PEHero lever hvor dit deal team allerede arbejder. Toogtyve specialist-agenter deler en enkelt model af din pipeline, din portefølje og dit marked. Hver agent har sine egne tools og prompts — og de videregiver artifacts mellem hinanden uden at associate skal re-keye noget.",
                          "fr": "PEHero vit là où votre équipe de deals travaille déjà. Vingt-deux agents spécialistes partagent un modèle unique de votre pipeline, de votre portefeuille et de votre marché. Chaque agent a ses propres outils et prompts — et ils transmettent des artefacts entre eux sans que l'associé ne ressaisisse quoi que ce soit.",
                          "de": "PEHero lebt dort, wo Ihr Deal-Team bereits arbeitet. Zweiundzwanzig Spezialisten-Agents teilen sich ein einziges Modell Ihrer Pipeline, Ihres Portfolios und Ihres Marktes. Jeder Agent hat seine eigenen Tools und Prompts — und sie geben Artefakte untereinander weiter, ohne dass der Associate etwas neu eingibt.",
                          "pl": "PEHero żyje tam, gdzie Twój zespół transakcyjny już pracuje. Dwadzieścia dwa wyspecjalizowane agenty dzielą jeden model Twojego pipeline'u, portfolio i rynku. Każdy agent ma własne narzędzia i prompty — i przekazują artefakty między sobą bez associate'a przepisującego cokolwiek."},
    ...
    "platform_rag":      {"en": "Postgres + pgvector index of every CIM, QoE, MSA, legal DD memo, ESG assessment, and industry report in your deal.",
                          ...
                          "lv": "Postgres + pgvector indekss katram CIM, QoE, MSA, juridiskajam DD memo, ESG novērtējumam un nozares ziņojumam jūsu darījumā.",
                          "no": "Postgres + pgvector-indeks av hver CIM, QoE, MSA, legal DD memo, ESG-vurdering og bransjerapport i din deal.",
                          "da": "Postgres + pgvector index af hver CIM, QoE, MSA, legal DD memo, ESG assessment og industry report i din deal.",
                          "fr": "Postgres + index pgvector de chaque CIM, QoE, MSA, mémo DD juridique, évaluation ESG et rapport sectoriel dans votre deal.",
                          "de": "Postgres + pgvector-Index jedes CIM, QoE, MSA, Legal-DD-Memo, ESG-Assessments und Branchenberichts in Ihrem Deal.",
                          "pl": "Postgres + pgvector index każdego CIM, QoE, MSA, legal DD memo, oceny ESG i raportu branżowego w Twojej transakcji."},
    ...
    "agents_eyebrow":    {"en": "Your Private Equity AI Agent Squad",
                          ...
                          "lv": "Jūsu Private Equity AI aģentu komanda",
                          "no": "Ditt Private Equity AI Agent Squad",
                          "da": "Dit Private Equity AI Agent Squad",
                          "fr": "Votre escouade d'agents IA pour le Private Equity",
                          "de": "Ihr Private-Equity-AI-Agent-Squad",
                          "pl": "Twój squad agentów AI Private Equity"},
    ...
    "hiw_02_title":      {"en": "Seller financials to IC-ready LBO in under an hour.",
                          ...
                          "lv": "Pārdevēja finanšu dati līdz IC gatavam LBO mazāk nekā stundā.",
                          "no": "Selgers finansdata til IC-klar LBO på under en time.",
                          "da": "Sælgers regnskaber til IC-klar LBO på under en time.",
                          "fr": "Des données vendeur à un LBO prêt pour l'IC en moins d'une heure.",
                          "de": "Verkäufer-Finanzen zu IC-bereitem LBO in unter einer Stunde.",
                          "pl": "Finanse sprzedawcy do LBO gotowego na IC w mniej niż godzinę."},
    "hiw_02_body":       {"en": "Cap Table Parser and LTM Normalizer ingest whatever format the banker sends. "
                          ...
                          "lv": "Cap Table Parser un LTM Normalizer ielādē jebkuru formātu, ko bankieris nosūta. LBO Model Builder izveido 5 gadu modeli ar jutīgumu. Debt Stack Modeler nosaka kapitāla struktūru. Return Metrics izvada IRR, MOIC un vērtības radīšanas tiltu.",
                          "no": "Cap Table Parser og LTM Normalizer tar imot det formatet banken sender. LBO Model Builder lager en 5-års modell med sensitivitet. Debt Stack Modeler dimensjonerer kapitalstrukturen. Return Metrics viser IRR, MOIC og verdiskapingsbroen.",
                          "da": "Cap Table Parser og LTM Normalizer indlæser det format banken sender. LBO Model Builder laver en 5-års-model med sensitivitet. Debt Stack Modeler dimensionerer kapitalstrukturen. Return Metrics viser IRR, MOIC og værdiskabelsesbroen.",
                          "fr": "Cap Table Parser et LTM Normalizer ingèrent le format envoyé par le banquier. LBO Model Builder génère un modèle 5 ans avec sensibilité. Debt Stack Modeler dimensionne la structure. Return Metrics sort IRR, MOIC et le pont de création de valeur.",
                          "de": "Cap Table Parser und LTM Normalizer verarbeiten jedes Format, das der Banker sendet. LBO Model Builder erstellt ein 5-Jahres-Modell mit Sensitivitätsanalyse. Debt Stack Modeler dimensioniert die Kapitalstruktur. Return Metrics gibt IRR, MOIC und die Value-Creation-Bridge aus.",
                          "pl": "Cap Table Parser i LTM Normalizer wczytują dowolny format od bankiera. LBO Model Builder tworzy 5-letni model z sensitivity. Debt Stack Modeler określa strukturę kapitału. Return Metrics wyprowadza IRR, MOIC i mostek kreacji wartości."},
    ...
    "hiw_03_body":       {"en": "VDR Auditor checks the seller data room against a 140-item PE checklist. "
                          ...
                          "lv": "VDR Auditor pārbauda pārdevēja datu telpu pret 140 vienību PE kontrolsarakstu. Contract Abstractor nolasa katru MSA. Legal & Regulatory, Operational Diligence un ESG aģenti atzīmē būtiskas problēmas ar lapu līmeņa atsaucēm.",
                          "no": "VDR Auditor sjekker selgers datarom mot en 140-punkts PE-sjekkliste. Contract Abstractor leser hver MSA. Legal & Regulatory, Operational Diligence og ESG-agenter flagger vesentlige forhold med sidereferanser.",
                          "da": "VDR Auditor tjekker sælgers datarum mod en 140-punkts PE-tjekliste. Contract Abstractor læser hver MSA. Legal & Regulatory, Operational Diligence og ESG-agenter markerer væsentlige forhold med sidehenvisninger.",
                          "fr": "VDR Auditor contrôle la data room vendeur avec une checklist PE de 140 points. Contract Abstractor lit chaque MSA. Les agents Legal & Regulatory, Operational Diligence et ESG signalent les problèmes avec citations par page.",
                          "de": "VDR Auditor prüft den Verkäufer-Datenraum gegen eine 140-Punkte-PE-Checkliste. Contract Abstractor liest jede MSA. Legal & Regulatory, Operational Diligence und ESG-Agenten markieren wesentliche Probleme mit seitenbezogenen Zitaten.",
                          "pl": "VDR Auditor sprawdza data room wobec 140-punktowej listy PE. Contract Abstractor czyta każdą MSA. Agenci Legal & Regulatory, Operational Diligence i ESG flagują kwestie z cytatami stron."},
    ...
    "contact_body":      {"en": "Send us a note and we'll set up a 20-minute walkthrough. We'll load one of your "
                          ...
                          "lv": "Nosūtiet mums ziņu, un mēs organizēsim 20 minūšu demonstrāciju. Mēs ielādēsim vienu no jūsu nesenajiem darījumiem PEHero un parādīsim pilnu aģenta plūsmu — tiešsaistē.",
                          "no": "Send oss en melding, så setter vi opp en 20-minutters gjennomgang. Vi laster inn en av dine nylige deals i PEHero og viser deg hele agentflyten — live.",
                          "da": "Send os en besked, så sætter vi en 20-minutters gennemgang op. Vi loader en af dine nylige deals ind i PEHero og viser dig det fulde agent-flow — live.",
                          "fr": "Envoyez-nous un message et nous organiserons une démo de 20 minutes. Nous chargerons l'un de vos deals récents dans PEHero et vous montrerons le flux complet des agents — en direct.",
                          "de": "Senden Sie uns eine Nachricht und wir richten einen 20-minütigen Walkthrough ein. Wir laden eines Ihrer aktuellen Deals in PEHero und zeigen Ihnen den vollständigen Agenten-Flow — live.",
                          "pl": "Wyślij nam wiadomość, a umówimy 20-minutowe demo. Załadujemy jedną z Twoich ostatnich transakcji do PEHero i pokażemy pełny przepływ agentów — na żywo."},
    ...
    "chat_placeholder":  {"en": "Ask anything — or type a prefix like `triage:`, `memo:`, `pf:`",
                          ...
                          "lv": "Jautājiet jebko — vai ierakstiet prefiksu, piemēram, `triage:`, `memo:`, `pf:`",
                          "no": "Spør om hva som helst — eller skriv et prefiks som `triage:`, `memo:`, `pf:`",
                          "da": "Spørg om hvad som helst — eller skriv et præfiks som `triage:`, `memo:`, `pf:`",
                          "fr": "Demandez n'importe quoi — ou tapez un préfixe comme `triage:`, `memo:`, `pf:`",
                          "de": "Fragen Sie alles — oder geben Sie ein Präfix wie `triage:`, `memo:`, `pf:` ein",
                          "pl": "Zapytaj o cokolwiek — lub wpisz prefiks jak `triage:`, `memo:`, `pf:`"},
    ...
    "chat_welcome_sub":  {"en": "Your Private Equity AI Agent Squad. Type a prompt — the router picks the right specialist.",
                          ...
                          "no": "Din Private Equity AI Agent Squad. Skriv en prompt — ruteren velger riktig spesialist.",
                          "da": "Dit Private Equity AI-agenthold. Skriv en prompt — routeren vælger den rette specialist.",
                          ...
                          "pl": "Twój zespół agentów AI Private Equity. Wpisz prompt — router wybierze odpowiedniego specjalistę."},
    "chat_canvas_empty": {"en": "Canvas renders here as agents produce them — company briefs, LBO models, comps tables, IC memo previews, RAG citations.",
                          ...
                          "lv": "Canvas renderējas šeit, kad aģenti tos rada — uzņēmumu kopsavilkumi, LBO modeļi, salīdzinājumu tabulas, IC memo priekšskatījumi, RAG citāti.",
                          "no": "Canvas gjengis her når agenter produserer dem — selskapsbriefs, LBO-modeller, comps-tabeller, IC-memo-forhåndsvisninger, RAG-sitater.",
                          "da": "Canvas gengives her, når agenter producerer dem — virksomhedsbriefs, LBO-modeller, comps-tabeller, IC-memo-forhåndsvisninger, RAG-citater.",
                          "fr": "Le Canvas s'affiche ici au fur et à mesure que les agents les produisent — briefs d'entreprise, modèles LBO, tableaux comps, aperçus de mémo IC, citations RAG.",
                          "de": "Canvas rendert hier, während Agenten sie produzieren — Unternehmensbriefings, LBO-Modelle, Comps-Tabellen, IC-Memo-Vorschauen, RAG-Zitationen.",
                          "pl": "Canvas renderuje się tutaj, gdy agenci je tworzą — briefy firmowe, modele LBO, tabele comps, podglądy memo IC, cytaty RAG."},
    "chat_signin_title": {"en": "Sign in to PEHero", "et": "Logige PEHerosse sisse", "lt": "Prisijungti prie PEHero",
                          ...
                          "lv": "Pieslēgties PEHero",
                          "no": "Logg inn på PEHero",
                          "da": "Log ind på PEHero",
                          "fr": "Se connecter à PEHero",
                          "de": "Bei PEHero anmelden",
                          "pl": "Zaloguj się do PEHero"},
    ...
    "news_pe_heading":   {"en": "Private equity industry news",
                          ...
                          "lv": "Privātā kapitāla nozares ziņas",
                          "no": "Private equity-bransjenyheter",
                          "da": "Private equity-branchenyheder",
    ...
    "news_pe_sources":   {"en": "PE Hub · Buyouts Insider · PE International",
                          ...
                          "lv": "PE Hub · Buyouts Insider · PE International",
                          "no": "PE Hub · Buyouts Insider · PE International",
                          "da": "PE Hub · Buyouts Insider · PE International",
                          "fr": "PE Hub · Buyouts Insider · PE International",
                          "de": "PE Hub · Buyouts Insider · PE International",
                          "pl": "PE Hub · Buyouts Insider · PE International"},
    ...
    "pipe_input_hint":   {"en": "Ask about {company} — e.g. triage, LBO, DD findings",
                          ...
                          "lv": "Jautājiet par {company} — piem. triage, LBO, DD findings", "no": "Spør om {company} — f.eks. triage, LBO, DD findings", "da": "Spørg om {company} — f.eks. triage, LBO, DD findings", "fr": "Demandez à propos de {company} — ex. triage, LBO, conclusions DD", "de": "Fragen Sie zu {company} — z. B. Triage, LBO, DD findings", "pl": "Zapytaj o {company} — np. triage, LBO, DD findings"},
    ...
    "analytics_h2":      {"en": "Ask a question of your PE database.",
                          ...
                          "lv": "Uzdodiet jautājumu savai PE datubāzei.",
                          "no": "Still et spørsmål til PE-databasen din.",
                          "da": "Stil et spørgsmål til din PE-database.",
                          "fr": "Posez une question à votre base de données PE.",
                          "de": "Stellen Sie eine Frage an Ihre PE-Datenbank.",
                          "pl": "Zadaj pytanie swojej bazie danych PE."},
    "analytics_body":    {"en": "Questions are translated to SQL against the pehero schema, run read-only, "
                          ...
                          "lv": "Jautājumi tiek tulkoti uz SQL pret pehero shēmu, izpildīti tikai lasīšanai un attēloti kā Plotly diagramma plus neapstrādātā tabula.",
                          "no": "Spørsmål oversettes til SQL mot pehero-skjemaet, kjøres skrivebeskyttet og gjengis som et Plotly-diagram pluss den rå tabellen.",
                          "da": "Spørgsmål oversættes til SQL mod pehero-skemaet, køres skrivebeskyttet og gengives som et Plotly-diagram plus den rå tabel.",
                          "fr": "Les questions sont traduites en SQL sur le schéma pehero, exécutées en lecture seule et rendues sous forme de graphique Plotly plus le tableau brut.",
                          "de": "Fragen werden in SQL gegen das pehero-Schema übersetzt, nur lesend ausgeführt und als Plotly-Diagramm plus Roh-Tabelle gerendert.",
                          "pl": "Pytania są tłumaczone na SQL względem schematu pehero, wykonywane w trybie tylko do odczytu i renderowane jako wykres Plotly oraz surowa tabela."},
    ...
    "instr_shared":      {"en": "Edit shared PE glossary",
                          ...
                          "lv": "Rediģēt kopīgoto PE glosāriju",
                          "no": "Rediger delt PE-ordliste",
                          "da": "Rediger delt PE-ordliste",
                          "fr": "Modifier le glossaire PE partagé",
                          "de": "Geteiltes PE-Glossar bearbeiten",
                          "pl": "Edytuj wspólny glosariusz PE"},
    "instr_shared_title": {"en": "Shared PE glossary",
                          ...
                          "lv": "Kopīgotais PE glosārijs",
                          "no": "Delt PE-ordliste",
                          "da": "Delt PE-ordliste",
                          "fr": "Glossaire PE partagé",
                          "de": "Geteiltes PE-Glossar",
                          "pl": "Wspólny glosariusz PE"},
