    ...
    tiers = [
        {
            ...
            "cta": ("View on GitHub", "https://github.com/predictivelabsai/FastPE"),
            "primary": False,
        },
        {
            "name": "Hosted",
            ...
            "features": [
                ...
                "Same open-source product as BYOC",
                "Start fast without operating the stack",
            ],
            "cta": ("Talk to the team", "/contact"),
            "primary": True,
        },
    ]
    return page(
        ...
        Section_(
            ...
            Heading(1, "Simple pricing for every FastSME product.", cls="mt-4 max-w-4xl"),
            P("BYOC free forever, or host with us for €1 per product per month.",
              cls="mt-6 text-ink-muted text-lg max-w-3xl leading-relaxed"),
            cls="border-t border-line",
        ),
        Section_(
